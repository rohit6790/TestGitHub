...
//					"<td width='52%' bgcolor='#CCCCFF'align='center'><b><font color='#000000' face='Tahoma' size='2'>Status</font></b></td>");
			...
			consolidatePrintHtml.println(
					"<td width='30%' bgcolor='#CCCCFF'align='center'><b><font color='#000000' face='Tahoma' size='2'>TestCase Pass Percent</font></b></td>");
			consolidatePrintHtml.println("</tr>");
		} catch (Exception ex) {
			ex.printStackTrace();
		}
	...
	public void checkTestCaseStatus(File testCaseFile) {
		...
		try {
			...
			while (line != null) {
				...
				String[] sub1;
				if (line.contains("Steps Passed") && !line.contains("Total")) {
					String[] lines = line.split("Steps Passed");
...
//							+ strPassFail + "</font></b></td>");
		...
		consolidatePrintHtml.println(
				"<td width='20%' bgcolor='#FFFFDC' valign='top' align='center' ><font color='#000000' face='Tahoma' size='2'>"
...
//						+ FailRate + "%</b></td> </tr></table>");
	...
	public File createTempDir() throws IOException {
		...
		File sysTempDir = new File(resultPath, "ExecutionReport" + GlobalParam.slash + GlobalParam.APP_NAME);
