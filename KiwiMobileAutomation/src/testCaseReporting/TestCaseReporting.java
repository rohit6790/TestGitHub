...
public class TestCaseReporting extends Reporting {
	...
	public void teststepreporting(String strActualResult, String strPassFail, String sExpectedMessage) { // ##U
		try {
			if (!DriverSession.getReporting() && !strPassFail.equals("FAIL"))
				return;
			...
			if (strPassFail.toUpperCase() == "PASS") {
				printhtml
						.append("<td width='18%' bgcolor='#FFFFDC' valign='middle' align='center'><b><font color='#000000' face='Tahoma' size='2'>"
								+ strPassFail.toUpperCase() + "</font></b></td>");
	...
	public void footer() { // ##U
		try {
			...
			printhtml.println(
					"<tr><td width='45%' bgcolor='#FFFFDC'><b><font face='Tahoma' size='2'>Total No. of Steps</font></b></td><td width='55%' bgcolor='#FFFFDC'><font face='Tahoma' size='2'>"
							+ getTotalNoOfSteps() + "</td></tr>");
			printhtml.println(
			...
			printhtml.println(
					"<tr><td width='45%' bgcolor='#FFFFDC'><b><font face='Tahoma' size='2'>Total Steps Failed</font></b></td><td width='55%' bgcolor='#FFFFDC'><font face='Tahoma' size='2'>"
							+ FailCount + "</td></tr>");
			printhtml.println(
					"<tr><td width='45%' bgcolor='#FFFFDC'><b><font face='Tahoma' size='2'>Executed On (YYYY:MM:DD)</font></b></td><td width='55%' bgcolor= '#FFFFDC'><font face='Tahoma' size='2'>"
							+ getSystemDate() + "</td></tr>");
			printhtml.println(
			...
			printhtml.println(
					"<tr><td width='45%' bgcolor='#FFFFDC'><b><font face='Tahoma' size='2'>Execution Time (HH:MM:SS)</font></b></td><td width='55%' bgcolor= '#FFFFDC'><font face='Tahoma' size='2'>"
			...
			printhtml.println(
					"<table border=0 cellspacing=1 cellpadding=1 ><tr>  <td width=120 bgcolor= '#FFFFDC'><FONT  FACE='Tahoma' SIZE=2.75 ><b>Total No. of Steps</b></td> <td width=10 bgcolor= '#FFFFDC'><FONT  FACE='Tahoma' SIZE=2.75><b>:</b></td>     <td width=35 bgcolor= '#FFFFDC'><FONT FACE='Tahoma' SIZE=2.75><b>"
			...
			printhtml.println(
					"<table border=0 cellspacing=1 cellpadding=1 ><tr>  <td width=120 bgcolor= '#FFFFDC'><FONT  FACE='Tahoma' SIZE=2.75 ><b>Steps Passed</b></td> <td width=10 bgcolor= '#FFFFDC'><FONT  FACE='Tahoma' SIZE=2.75><b>:</b></td>     <td width=35 bgcolor= '#FFFFDC'><FONT FACE='Tahoma' SIZE=2.75><b>"
			...
			printhtml.println(
					"<table border=0 cellspacing=1 cellpadding=1 ><tr> <td width=120 bgcolor= '#FFFFDC'><FONT   FACE='Tahoma' SIZE=2.75 ><b>Steps Failed</b></td>  <td width=10 bgcolor= '#FFFFDC'><FONT  FACE='Tahoma' SIZE=2.75><b>:</b></td>     <td width=35 bgcolor= '#FFFFDC'><FONT  FACE='Tahoma' SIZE=2.75><b>"
